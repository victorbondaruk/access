...
namespace VictorBondaruk\Access\Console;
...
class InstallCommand extends Command implements PromptsForMissingInput
{
     ...
     * @var string
     */
    protected $signature = 'access:install {stack : The development stack that should be installed (inertia)}
     ...
     * @var string
     */
    protected $description = 'Install the Access components and resources';
    ...
    public function handle()
    {
        if (!in_array($this->argument('stack'), ['inertia'])) {
            $this->components->error('Invalid stack. Supported stacks are [inertia].');
    ...
    /**
     * Configure the session driver for Access.
     *
     * @return void
     */
    ...
    protected function ensureApplicationIsTeamCompatible()
    {
        ...
        // Service Providers...
        copy(__DIR__ . '/../../stubs/app/Providers/AccessWithTeamsServiceProvider.php', app_path('Providers/AccessServiceProvider.php'));
        ...
        // Actions...
        copy(__DIR__ . '/../../stubs/app/Actions/Access/AddTeamMember.php', app_path('Actions/Access/AddTeamMember.php'));
        copy(__DIR__ . '/../../stubs/app/Actions/Access/CreateTeam.php', app_path('Actions/Access/CreateTeam.php'));
        copy(__DIR__ . '/../../stubs/app/Actions/Access/DeleteTeam.php', app_path('Actions/Access/DeleteTeam.php'));
        copy(__DIR__ . '/../../stubs/app/Actions/Access/DeleteUserWithTeams.php', app_path('Actions/Access/DeleteUser.php'));
        copy(__DIR__ . '/../../stubs/app/Actions/Access/InviteTeamMember.php', app_path('Actions/Access/InviteTeamMember.php'));
        copy(__DIR__ . '/../../stubs/app/Actions/Access/RemoveTeamMember.php', app_path('Actions/Access/RemoveTeamMember.php'));
        copy(__DIR__ . '/../../stubs/app/Actions/Access/UpdateTeamName.php', app_path('Actions/Access/UpdateTeamName.php'));
    ...
    protected function promptForMissingArgumentsUsing()
    {
        return [
            'stack' => fn () => select(
                label: 'Which Access stack would you like to install?',
                options: [
